...
// ============================================================================
// MÀN HÌNH MD CŨ — ĐƯỢC GIỮ LẠI, HIỆN CHƯA GẮN VÀO ROUTE NÀO
//
// Trước đây đây là app/(dashboard)/md/page.tsx. Bàn làm việc Merchandiser mới
// (5 nhóm chức năng) đã thay chỗ, nhưng file này KHÔNG bị xoá vì vẫn chứa ba
// phần nghiệp vụ có dữ liệu thật: BOM nguyên phụ liệu, tiến độ mẫu
// (Proto->Fit->SMS->PP->TOP) và costing/margin.
//
// Muốn dùng lại: import vào md-client.tsx như một tab thứ sáu.
//
