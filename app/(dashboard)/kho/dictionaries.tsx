...
// ============================================================================
// ĐĂNG KÝ TỪ ĐIỂN CHO NHÁNH ROUTE `/kho`
//
...
//
// ⚠️ CHỈ `WAREHOUSE_DICT`. Kho ⛔ không tra khoá `md_*` nào — thêm `MD_DICT`
// vào đây là kéo lại đúng 65 KB vừa cắt được.
// ============================================================================
...
export default function DangKyTuDienKho(): null {
  return null;
}
