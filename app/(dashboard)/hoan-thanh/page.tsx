          ...
          <div id="ghi-qc" className="scroll-mt-24 bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <ActionForm
              action={async (_truoc, formData) => {
                'use server'
                return await createFinishingLog(formData)
              }}
              nutChu="Ghi Nhận & Chuyển Đóng Thùng" className="space-y-4"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div id="dong-thung" className="scroll-mt-24 bg-white rounded-xl border border-blue-200 shadow-sm p-6 h-fit bg-blue-50/30">
            ...
            <ActionForm
              action={async (_truoc, formData) => {
                'use server'
                return await createCarton(formData)
              }}
              nutChu="Sinh Mã Thùng (PACKED)" className="space-y-4"
            >
