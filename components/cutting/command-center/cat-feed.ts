import { Scissors, AlertTriangle, CircleAlert, CheckCircle2, Gauge } from 'lucide-react';
...
// ============================================================================
// FEED ADAPTER — TỔ CẮT · Blueprint hợp nhất *(Board Directive 05/08/2026)*
//
...
//
// 🔑 Nhờ vậy khối MOS **⛔ không biết gì về Tổ cắt** — nó ⛔ không có bảng tra
 ...
 *
 * Tổ cắt ⛔ **không** đo mức khẩn bằng ngày — nó đo bằng **mức nghiêm trọng**. Quy
...
export function catFeed(
  ...
  const tasks: MosTask[] = vao.viec.map((v) => ({
    ...
    // ⚠️ Tổ cắt ⛔ chưa có câu phụ riêng cho từng việc. Để **chuỗi rỗng**, ⛔ KHÔNG
